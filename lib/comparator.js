 ...
 *  5. zh
 */
export const buildCascadeForBasicRange = (basicRange) => {
...
export const basicRangeStrictMatchesTag = (basicRange, tag) => {
...
export const basicRangeContainsTag = (basicRange, tag) => {
    if (basicRange === WILDCARD)
        return true;
    let downShiftedRange = basicRange.toLowerCase();
    let downShiftedTag = tag.toLowerCase();
...
export const extendedRangeContainsTag = (extendedRange, tag) => {
